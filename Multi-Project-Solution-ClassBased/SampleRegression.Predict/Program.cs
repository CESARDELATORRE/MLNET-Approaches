...
namespace SampleRegression.Predict
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SampleObservation sampleData = CreateSampleData();

            // Create ML model scorer helper
            SampleRegressionModelScorer modelScorer = new SampleRegressionModelScorer(MODEL_RELATIVE_PATH);
        ...
        private static SampleObservation CreateSampleData()
        {
